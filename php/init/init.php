...
$sql = "CREATE TABLE publish( ".
		"publish_id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, ".
        "user_id BIGINT NOT NULL, ".
        "type VARCHAR(10), ".
        "title VARCHAR(280) ,".
        "msg VARCHAR(280), ".
...
$sql = "INSERT INTO publish ".
        "(user_id, type, title, msg, image_id, image_count, submission_time) ".
        "VALUES ".
        "('$user_id','lost','寻找校园卡', '校园卡丢了，地标河西食堂，卡号10152150127', 1, 1, '$submission_time')";
$retval = mysqli_query( $conn, $sql );
if(! $retval )
{
  die('无法插入数据: ' . mysqli_error($conn));
